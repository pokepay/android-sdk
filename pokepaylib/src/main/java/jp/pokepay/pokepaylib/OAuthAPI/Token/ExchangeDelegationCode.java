...
public class ExchangeDelegationCode extends OAuthRequest {
    @NonNull
    public String code;
    @NonNull
    public String grantType = "urn:pokepay:delegation-code";
    @NonNull
    public String clientId;
    @NonNull
    public String clientSecret;

    public ExchangeDelegationCode(@NonNull String code, @NonNull String clientId, @NonNull String clientSecret) {
        this.code = code;
