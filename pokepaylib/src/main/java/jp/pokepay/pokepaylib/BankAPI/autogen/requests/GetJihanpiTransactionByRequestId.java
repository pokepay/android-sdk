...
public class GetJihanpiTransactionByRequestId extends BankRequest {
    private String requestId;

    public GetJihanpiTransactionByRequestId(String requestId) {
    ...
    @Override
    public String path() {
        return "/jihanpi-transactions" + "/requests" + "/" + this.requestId;
    }
