...
public class CreateTransactionWithCheck extends BankRequest {
    ...
    public CreateTransactionWithCheck(String checkId) {
        this.checkId = checkId;
    }

    public CreateTransactionWithCheck requestId(String requestId) {
        this.requestId = requestId;
        return this;
    }

    public CreateTransactionWithCheck accountId(String accountId) {
