...
/**
 * @deprecated Use {@link jp.pokepay.pokepaylib.BankAPI.autogen.requests.GetAccountTransfers} instead.
...
public class GetAccountTransfers extends BankRequest {
    ...
    public GetAccountTransfers(@NonNull String id, String before, String after, int perPage) {
        this.id = id;
        this.before = before;
        this.after = after;
        this.perPage = perPage;
    ...
    public GetAccountTransfers(@NonNull String id, String before, String after) {
        this.id = id;
        this.before = before;
        this.after = after;
    }
