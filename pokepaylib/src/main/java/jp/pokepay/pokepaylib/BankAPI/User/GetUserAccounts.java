...
/**
 * @deprecated Use {@link jp.pokepay.pokepaylib.BankAPI.autogen.requests.GetUserAccounts} instead.
...
public class GetUserAccounts extends BankRequest {
    ...
    public GetUserAccounts(@NonNull String id, String before, String after) {
        this.id = id;
        this.before = before;
        this.after = after;
    }

    public GetUserAccounts(@NonNull String id, String before, String after, int perPage) {
        this.id = id;
        this.before = before;
        this.after = after;
        this.perPage = perPage;
