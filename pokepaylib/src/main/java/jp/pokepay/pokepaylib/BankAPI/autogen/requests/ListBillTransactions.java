...
public class ListBillTransactions extends BankRequest {
    private String billId;
    private String before;
    private String after;
    private Integer perPage;

    public ListBillTransactions(String billId) {
        this.billId = billId;
    }

    public ListBillTransactions before(String before) {
        this.before = before;
        return this;
    }

    public ListBillTransactions after(String after) {
        this.after = after;
        return this;
    }
