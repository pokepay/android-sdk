...
Request request = new GetAccountTransactions(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
        ...
        .before("4X7ZEq")                         // ページングのためのパラメータです。
        .after("8UG")                             // ページングのためのパラメータです。
        .perPage(3);                              // 1ページあたりに表示する取引履歴の件数です。デフォルト値は30件です。
...
Request request = new SendToAccount(
    ...
    5029.0
        ...
        .description("Mat7Q5BMcC1v73v60y8DMLWrlnr061xWZsz1ogogHitDMic7XGDhIwoiIw8buBfBCDG7j4DoWkpZIbqBi9TROGFtlR9rLj2Y1ER9gKdUSrcKHlFd3Ur1MCMIUROIYftW7QMsIbzCAj1GsSvfXjxUW5PMdDu");
...
Request request = new GetAccountTransfers(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
        ...
        .before("sMe")                            // ページングのためのパラメータです。
        .after("04P")                             // ページングのためのパラメータです。
        .perPage(85);                             // 1ページあたりに表示する取引履歴の件数です。デフォルト値は30件です。
